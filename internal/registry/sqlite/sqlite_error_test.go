...
// TestMigrationSetsUserVersion confirms migration records PRAGMA user_version = 2
// (bumped from v1 by PR C, which adds the additive RFC-0001 columns), the marker
// later migrations key off.
